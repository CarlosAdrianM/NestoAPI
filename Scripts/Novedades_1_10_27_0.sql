...
VALUES
(@version, @fecha, 'Nuevo', 'Pestaña "Retrasados" en Agencias: envíos que la agencia no da por entregados',
 'Al lado de Incidentados hay una pestaña nueva con los envíos que salieron hace más de N días (4 por defecto) y de los que la agencia todavía no ha confirmado la entrega. Se ve el último evento que contó la agencia ("REPARTO", "DOCUMENTADO"...), los días que lleva, y las filas se colorean: ámbar de 6 a 10 días, rojo a partir de 11. Se puede filtrar por vendedor y por la agencia seleccionada. Al elegir una fila funcionan "Abrir seguimiento" (o doble clic), "Actualizar estado" y el menú de copiar nº de pedido / envío; si al actualizar resulta entregado, desaparece de la lista. Sirve para llamar al cliente antes de que llame él: un envío estuvo 19 días "en reparto" sin que nadie lo viera.', 'Nesto', 1, 'sa'),

(@version, @fecha, 'Nuevo', 'Pausar la venta de una casa entera en la tienda desde el mantenimiento de familias',
...
(@version, @fecha, 'Corregido', 'El aviso "ha cogido picking" con importe mostraba el importe de la línea entera cuando salía solo una parte',
 'En los pedidos con la casilla "Avisar con importe cuando coja picking", si de una línea de 15 unidades salían 2, el correo decía cantidad 2 pero el importe de las 15 (pedido 925872: 176,41 € cuando lo que salía eran 53,79 €). Ahora el importe es el de lo que sale de verdad. Solo afectaba al correo; el albarán y el stock estaban bien.', 'NestoAPI', 1, 'sa'),

(@version, @fecha, 'Corregido', 'Los correos post-compra ya no saludan con el nombre de la empresa',
 'El sábado 12 salieron saludos como "Hola The Look Getafe SL". Cuando el nombre del cliente es una sociedad (S.L., S.A., SRL...) o no es un nombre de persona, el saludo es genérico ("Hola"). Además, los nombres se procesan en grupos más pequeños, que es donde empezó a fallar.', 'NestoAPI', 1, 'sa'),

(@version, @fecha, 'Corregido', 'Dejan de llegar los avisos de "NIF incorrecto" del cliente 9500 PEDIDO TIENDA',
 'El 9500 es un cliente ficticio de venta en tienda (NIF "00") cuyas facturas son simplificadas, como el 10458 VENTA TIENDA. El circuito de comprobación de NIF lo trataba como un cliente real y mandaba un aviso en cada pedido. Ya no.', 'NestoAPI', 1, 'sa');
