    ...
    public class PlantillaVentasController : ApiController
    {
        ...
        public IQueryable<LineaPlantillaVenta> GetPlantillaVentas(string empresa, string cliente)
        {
            ...
            List<LineaPlantillaVenta> lineasPlantilla = db.LinPedidoVtas
                ...
                .Where(l => (l.Empresa == empresa || l.Empresa == empresaBuscada.IVA_por_defecto) && l.Nº_Cliente == cliente && l.TipoLinea == 1 && !l.Ficticio && l.Estado >= 0 && l.estadoLinea == 4 && l.Fecha_Albarán >= DbFunctions.AddYears(DateTime.Today,-5)) // ojo, es el estado del producto
