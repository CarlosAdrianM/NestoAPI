...
{
    // Los nombres de propiedad mantienen los acentos/ñ porque deben coincidir
    // EXACTAMENTE con los <DataField> del RDLC (Nesto/Informes/Packing.rdlc)
    // para que el data binding del ReportViewer funcione tras deserializar el JSON.
