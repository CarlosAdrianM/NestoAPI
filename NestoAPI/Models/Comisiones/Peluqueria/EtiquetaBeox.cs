...
{
    public class EtiquetaBeox : EtiquetaComisionVentaBase, IEtiquetaComisionVenta
    {
        ...
        public override string Nombre => "Beox";
        ...
        {
            return new EtiquetaBeox(_servicioComisiones)
            {
                Venta = Venta,
                Tipo = Tipo
            };
