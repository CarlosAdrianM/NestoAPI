...
{
    public class EtiquetaEvaVisnu : EtiquetaComisionVentaBase, IEtiquetaComisionVenta
    {
        ...
        public override string Nombre => "Eva Visnú";
        ...
        {
            return new EtiquetaEvaVisnu(_servicioComisiones)
            {
                Venta = Venta,
                Tipo = Tipo
            };
