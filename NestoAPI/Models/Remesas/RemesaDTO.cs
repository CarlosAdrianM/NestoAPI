...
namespace NestoAPI.Models.Remesas
{
    ...
    /// </summary>
    /// <summary>
    /// Nesto#340 Fase 1C.14 slice 7: fichero SEPA de impagados del banco a contabilizar.
    /// </summary>
    public class ContabilizarImpagadosRequest
    {
        public string Fichero { get; set; }
    }

    /// <summary>
    /// Nesto#340 Fase 1C.14 slice 8: efecto de un asiento de impagados con los datos del
    /// cliente, para crear las tareas de Planner de gestión de cobro.
    /// </summary>
    public class TareaImpagadoDTO
    {
        public string Cliente { get; set; }
        public string Contacto { get; set; }
        public DateTime Fecha { get; set; }
